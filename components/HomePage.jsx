...
export default function HomePage() {
  ...
  return (
    <div className="flex justify-center items-center h-screen px-2">
      ...
      <div className="shadow-lg p-4 bg-zinc-300/10 flex flex-col gap-2 my-2 w-full h-full">

        <h1 className="text-3xl text-slate-600 font-bold font-serif">Welcome Page</h1>
        
        <div className="grid-cols-1">
            <p className="self-center text-slate-600 font-serif">Hi <span className="mr-8 ml-1/2 font-extralight">{firstName},</span></p>
